package anamikroservisi.korisnicki_servis.controller;

import anamikroservisi.korisnicki_servis.dto.*;
import anamikroservisi.korisnicki_servis.security.CheckSecurity;
...
//    @CheckSecurity(roles = {"admin"})
    ...
    public ResponseEntity<UserCreateDto> updateUser(@RequestHeader("Authorization") String authorization, @PathVariable Long id, @RequestBody UserCreateDto userCreateDTO){
